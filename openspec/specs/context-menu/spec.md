...
## Purpose
The released GUI exposes the webview's default context menu so a right-click over a text selection offers cut/copy/paste, matching the menu already available under `wails dev`.
## Requirements
